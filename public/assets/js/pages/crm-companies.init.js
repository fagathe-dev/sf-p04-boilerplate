...
function ischeckboxcheck() {
  Array.from(document.getElementsByName('chk_child')).forEach(function (e) {
    e.addEventListener('change', function (t) {
      ...
      var n = document.querySelectorAll('[name="chk_child"]:checked').length;
  ...
  (removeBtns &&
    Array.from(removeBtns).forEach(function (e) {
      e.addEventListener('click', function (e) {
        ...
        var t = companyList.get({ id: itemId });
      ...
      e.addEventListener('click', function (e) {
        ...
        Array.from(t).forEach(function (e) {
          if (
            ...
            document.getElementById('company-view-detail').innerHTML = t;
          }
        });
      });
    }));
      ...
      if (e.checkValidity())
        if (
          ...
          if (
            ...
            var n = companyList.get({ id: idField.value });
