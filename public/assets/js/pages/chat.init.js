function searchMessages() {
  var e, t, s, n;
  ((e = document.getElementById('searchMessage')),
    (t = e.value.toUpperCase()),
    (s = document
      .getElementById('users-conversation')
      .getElementsByTagName('li')),
    Array.from(s).forEach(function (e) {
      ((n = e.getElementsByTagName('p')[0]
        ? e.getElementsByTagName('p')[0]
        : ''),
        (n.textContent || n.innerText ? n.textContent || n.innerText : '')
          .toUpperCase()
          .indexOf(t) > -1
          ? (e.style.display = '')
...
!(function () {
  var e = '/assets/images/users/user-dummy-img.jpg',
    t = '/assets/images/users/multi-user.jpg',
    s = !1;
  function n() {
    var e = document.querySelectorAll('.user-chat');
    (Array.from(document.querySelectorAll('.chat-user-list li a')).forEach(
      function (t) {
        t.addEventListener('click', function (t) {
          ...
          var s = document.querySelector('.chat-user-list li.active');
          (s && s.classList.remove('active'),
            this.parentNode.classList.add('active'));
        });
      },
    ),
      document.querySelectorAll('.user-chat-remove').forEach(function (t) {
        t.addEventListener('click', function (t) {
          e.forEach(function (e) {
    ...
    ((t = e),
      (n = function (e, t) {
        if (null !== e) console.log('Something went wrong: ' + e);
          ...
          var n = 'users' == r ? t[0].chats : t[0].channel_chat;
          document.getElementById(r + '-conversation').innerHTML = '';
          var a = 0;
          n.forEach(function (e, t) {
            if (a > 0) a -= 1;
            else {
              var s = e.from_id == c ? ' right' : ' left',
                i = o.find(function (t) {
                  return t.id == e.to_id;
                }),
                l =
              ...
              (c != e.from_id &&
                ...
                n[t + 1] &&
                  ...
                  (l += (function (e, t, s, n) {
                    for (var a = 0; e[t] && e[t + 1] && e[t + 1].from_id == s; )
                      ((a = m(
                        e[t + 1].id,
                        e[t + 1].msg,
                        e[t + 1].has_images,
                ...
                (l += '</div>                </div>            </li>'),
                (document.getElementById(r + '-conversation').innerHTML += l));
            }
          });
        }
        (b.querySelectorAll('.delete-item').forEach(function (e) {
          ...
          w(),
          (function () {
            var e = b.querySelectorAll('.reply-message'),
              t = document.querySelector('.replyCard'),
            ...
            e.forEach(function (e) {
              e.addEventListener('click', function () {
                ...
                var a =
                  e.closest('.ctext-wrap').children[0].children[0].innerText;
                ...
                var r = document.querySelector(
                  ...
                  i = e.closest('.chat-list')
                    ? e.closest('.chat-list').classList.contains('left')
                      ? r
                      : 'You'
                    : r;
                document.querySelector(
          ...
          (function () {
            var e = E.querySelectorAll('.reply-message'),
              t = document.querySelector('.replyCard'),
              n = document.querySelector('#close_toggle');
            e.forEach(function (e) {
              e.addEventListener('click', function () {
          ...
          (function () {
            var e = b.querySelectorAll('.copy-message');
            e.forEach(function (e) {
              e.addEventListener('click', function () {
                var t = e.closest('.ctext-wrap').children[0]
                  ? e.closest('.ctext-wrap').children[0].children[0].innerText
                  : '';
          ...
          (function () {
            var e = E.querySelectorAll('.copy-message');
            e.forEach(function (e) {
              e.addEventListener('click', function () {
                var t = e.closest('.ctext-wrap').children[0]
                  ? e.closest('.ctext-wrap').children[0].children[0].innerText
    ...
    setTimeout(function () {
      var t = document
          ...
          ? document
              ...
              .querySelector('#chat-conversation .simplebar-content-wrapper')
          : '',
        s = document.getElementsByClassName('chat-conversation-list')[0]
          ? document
              .getElementById(e)
            ...
            335
          : 0;
      s && t.scrollTo({ top: s, behavior: 'smooth' });
    }, 100);
  }
  (d('chat-users-list.json', function (i, l) {
    null !== i
      ? console.log('Something went wrong: ' + i)
      : (l[0].users.forEach(function (e, t) {
          var s = e.profile
              ? '<img src="' +
                e.profile +
        ...
        l[0].channels.forEach(function (e, t) {
    ...
    (n(),
      document.querySelectorAll('#userList li').forEach(function (t) {
        t.addEventListener('click', function () {
          ((r = 'users'), u(), (a = 'users-chat'));
          var n = t.getAttribute('id'),
            i = t.querySelector('.text-truncate').innerHTML;
          if (
            ((document.querySelector(
              '.user-chat-topbar .text-truncate .username',
            ).innerHTML = i),
            ...
            document.getElementById(n).querySelector('.userprofile'))
          ) {
            var l = document
              .getElementById(n)
          ...
          (document
            ...
            .forEach(function (t) {
              l
                ? t.querySelector('img').setAttribute('src', l)
                : t.querySelector('img').setAttribute('src', e);
            }),
            window.stop());
        });
      }),
      document.querySelectorAll('#channelList li').forEach(function (e) {
        e.addEventListener('click', function () {
          ((a = 'channel-chat'), (r = 'channel'), u());
          var n = e.querySelector('.text-truncate').innerHTML,
            i = document.getElementById('channel-chat');
          ((i.querySelector(
            '.user-chat-topbar .text-truncate .username',
          ).innerHTML = n),
            (document.querySelector('.profile-offcanvas .username').innerHTML =
    ...
    d('chat-contacts-list.json', function (t, a) {
      if (null !== t) console.log('Something went wrong: ' + t);
      else {
        ((o = a),
          a.sort(function (e, t) {
        ...
        o.forEach(function (e, t) {
          ...
          (l != e.name.charAt(0) &&
            (document.getElementsByClassName('sort-contact')[0].innerHTML += n),
            (document.getElementById(
      ...
      (document.querySelectorAll('.sort-contact ul li').forEach(function (t) {
        t.addEventListener('click', function (n) {
          ((r = 'users'), u());
          var a = t.querySelector('li .contactlist-name').innerHTML;
          if (
            ((document.querySelector(
              '.user-chat-topbar .text-truncate .username',
            ).innerHTML = a),
          ...
          (document
            ...
            .forEach(function (t) {
              i
                ? t.querySelector('img').setAttribute('src', i)
                : t.querySelector('img').setAttribute('src', e);
            }),
            window.stop());
        });
  ...
  function y() {
    var e = new Date().getHours() >= 12 ? 'pm' : 'am',
      t =
  ...
  function S() {
    ((channelChatList = E.querySelectorAll('.delete-item')),
      channelChatList.forEach(function (e) {
        e.addEventListener('click', function () {
          2 == e.closest('.user-chat-content').childElementCount
            ? e.closest('.chat-list').remove()
            : e.closest('.ctext-wrap').remove();
  ...
  var q = function (e, t) {
      ...
      var a = document.getElementById('chat-list-' + x);
      (a.querySelectorAll('.delete-item').forEach(function (e) {
        ...
        a.querySelectorAll('.copy-message').forEach(function (e) {
          e.addEventListener('click', function () {
            var e =
              a.childNodes[1].firstElementChild.firstElementChild
        ...
        a.querySelectorAll('.reply-message').forEach(function (e) {
          e.addEventListener('click', function () {
            var t = document.querySelector('.replyCard'),
              n = document.querySelector('#close_toggle'),
              a = e.closest('.ctext-wrap').children[0].children[0].innerText,
    ...
    k = function (e, t) {
      ...
      var r = document.getElementById('chat-list-' + x);
      (r.querySelectorAll('.delete-item').forEach(function (e) {
        ...
        r.querySelectorAll('.reply-message').forEach(function (e) {
          e.addEventListener('click', function () {
            var t = e.closest('.ctext-wrap').children[0].children[0].innerText,
        ...
        r.querySelectorAll('.copy-message').forEach(function (e) {
          e.addEventListener('click', function () {
            (r.childNodes[1].children[1].firstElementChild.firstElementChild.getAttribute(
              'id',
            ),
              (isText =
                r.childNodes[1].children[1].firstElementChild.firstElementChild
                  .innerText),
  ...
  document.getElementById('emoji-btn').addEventListener('click', function () {
    setTimeout(function () {
      var e = document.getElementsByClassName('fg-emoji-picker')[0];
      if (e) {
        var t = window.getComputedStyle(e)
          ? window.getComputedStyle(e).getPropertyValue('left')
          : '';
        t && ((t = (t = t.replace('px', '')) - 40 + 'px'), (e.style.left = t));
      }
    }, 0);
  });
})();
