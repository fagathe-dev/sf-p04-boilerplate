...
function SearchData() {
  var e = document.getElementById('idStatus').value,
    t = document.getElementById('idPayment').value,
    a = document.getElementById('demo-datepicker').value,
    n = a.split(' to ')[0],
    l = a.split(' to ')[1];
  (orderList.filter(function (s) {
    matchData = new DOMParser().parseFromString(s.values().status, 'text/html');
    var r = matchData.body.firstElementChild.innerHTML,
      i = !1,
      d = !1,
      o = !1;
    return (
      (i = 'all' == r || 'all' == e || r == e),
      (d =
        'all' == s.values().payment || 'all' == t || s.values().payment == t),
      (o =
        new Date(s.values().date.slice(0, 12)) >= new Date(n) &&
        new Date(s.values().date.slice(0, 12)) <= new Date(l)),
      i && d && o
        ? i && d && o
        : i && d && '' == a
          ? i && d
      ...
      if (e.checkValidity())
        if (
          ...
          if (
            ...
            var a = orderList.get({ id: idField.value });
        ...
        e.addEventListener('click', function (e) {
          ...
          Array.from(t).forEach(function (e) {
            ...
            if (t == itemId) {
              ...
              var a = e._values.payment;
              (example.setChoiceByValue(a),
                productnameVal && productnameVal.destroy(),
                (productnameVal = new Choices(productNameField, {
                  searchEnabled: !1,
                })));
              var n = e._values.product_name;
              (productnameVal.setChoiceByValue(n),
              ...
              var l = val.body.firstElementChild.innerHTML;
              (statusVal.setChoiceByValue(l),
