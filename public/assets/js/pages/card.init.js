    ...
    el &&
      el.addEventListener('click', function (e) {
        ...
        ((insertEl =
          ...
          a.children[1].insertAdjacentHTML('beforeend', insertEl));
        var t = a.getElementsByClassName('card-preloader')[0];
        setTimeout(
          function () {
            t.remove();
          },
  ...
  ((customLoader1 = document.querySelector(
    ...
    customLoader1 &&
      customLoader1.addEventListener('click', function (e) {
        e.preventDefault();
        var a = customLoader1.closest('.card');
        ((insertEl =
