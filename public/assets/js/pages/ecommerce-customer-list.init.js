...
function SearchData() {
  var e = document.getElementById('idStatus').value,
    ...
    a = t.split(' to ')[0],
    l = t.split(' to ')[1];
  (customerList.filter(function (i) {
    matchData = new DOMParser().parseFromString(i.values().status, 'text/html');
    var n = matchData.body.firstElementChild.innerHTML,
      s = !1,
      o = !1;
    return (
      (s = 'all' == n || 'all' == e || n == e),
      (o =
        ...
        new Date(i.values().date.slice(0, 12)) <= new Date(l)),
      s && o ? s && o : s && '' == t ? s : o && '' == t ? o : void 0
    );
  }),
    customerList.update());
}
      ...
      if (e.checkValidity())
        if (
          ...
          if (
            ...
            var a = customerList.get({ id: idField.value });
  ...
  (removeBtns &&
    Array.from(removeBtns).forEach(function (e) {
      e.addEventListener('click', function (e) {
        ...
        var t = customerList.get({ id: itemId });
