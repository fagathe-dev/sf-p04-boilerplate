  ...
  Array.from(document.querySelectorAll('.edit-list')).forEach(function (t) {
    t.addEventListener('click', function (r) {
      ((e = t.getAttribute('data-edit-id')),
        (allmemberlist = allmemberlist.map(function (t) {
          return (
            t.id == e &&
              ((editlist = !0),
              ...
              '' == t.memberImg
                ...
                : (document.getElementById('member-img').src = t.memberImg),
              (document.getElementById('cover-img').src = t.coverImg),
              (document.getElementById('memberid-input').value = t.id),
              ...
              (document.getElementById('task-input').value = t.tasks),
              document
...
function findNextId() {
  if (0 === allmemberlist.length) return 0;
  var e = fetchIdFromObj(allmemberlist[allmemberlist.length - 1]),
        ...
        document
          ...
          .addEventListener('click', function () {
            var t,
              r =
                ((t = e),
                allmemberlist.filter(function (e) {
                  return e.id != t;
                }));
            (loadTeamData((allmemberlist = r)),
...
function memberDetailShow() {
  Array.from(document.querySelectorAll('.team-box')).forEach(function (e) {
    e.querySelector('.member-name').addEventListener('click', function () {
      var t,
        r = e.querySelector('.member-name h5').innerHTML,
        m = e.querySelector('.member-designation').innerHTML;
      t = e.querySelector('.member-img')
        ? e.querySelector('.member-img').src
        : '/assets/images/users/user-dummy-img.jpg';
      var i = e.querySelector('.team-cover img').src,
        n = e.querySelector('.projects-num').innerHTML,
        a = e.querySelector('.tasks-num').innerHTML;
      ((document.querySelector('#member-overview .profile-img').src = t),
      ...
      e.addEventListener(
        ...
        function (t) {
          if (e.checkValidity()) {
            t.preventDefault();
            var r,
              m = document.getElementById('teammembersName').value,
              i = document.getElementById('designation').value,
              n = document.getElementById('member-img').src,
              a = document.getElementById('cover-img').src;
            r =
              '/assets/images/users/user-dummy-img.jpg' ==
              n.substring(n.indexOf('/as') + 1)
                ? ''
                : n;
            var l = m
              .match(/\b(\w)/g)
            ...
            if ('' === m || '' === i || editlist) {
              ...
              (allmemberlist.push(s), sortElementsById());
            }
