function timeConvert(e) {
  ...
  var a = time_s.split(':'),
    ...
    i = a[1],
    l = n >= 12 ? 'PM' : 'AM';
  return (n = (n %= 12) || 12) + ':' + (i = i < 10 ? '0' + i : i) + l;
}
...
Array.from(tagInputFieldValue).forEach((e, t) => {
  tagHtmlValue +=
    '<span class="badge bg-primary-subtle text-primary me-1">' + e + '</span>';
});
  ...
  (removeBtns &&
    Array.from(removeBtns).forEach(function (e) {
      e.addEventListener('click', function (e) {
        ...
        var t = contactList.get({ id: itemId });
      ...
      e.addEventListener('click', function (e) {
        ...
        Array.from(t).forEach(function (e) {
          if (
            ...
            document.getElementById('contact-view-detail').innerHTML = t;
          }
        });
      });
    }));
      ...
      if (e.checkValidity())
        if (
          ...
          if (
            ...
            var a = contactList.get({ id: idField.value });
          ...
          var n = tagInputField.getValue(!0),
            i = '';
