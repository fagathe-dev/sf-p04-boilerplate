!(function () {
  ...
  function s(e) {
    document.getElementById('header-lang-img') &&
      ...
      (function () {
        ...
        (e.open('GET', '/assets/lang/' + n + '.json'),
          (e.onreadystatechange = function () {
            if (4 === this.readyState && 200 === this.status) {
              var e = JSON.parse(this.responseText);
              Object.keys(e).forEach(function (t) {
                var a = document.querySelectorAll("[data-key='" + t + "']");
    ...
    if (document.querySelectorAll('.navbar-nav .collapse')) {
      ...
      Array.from(e).forEach(function (e) {
        ...
        (e.addEventListener('show.bs.collapse', function (a) {
          a.stopPropagation();
          var n = e.parentElement.closest('.collapse');
          if (n) {
            var o = n.querySelectorAll('.collapse');
            ...
            Array.from(s).forEach(function (e) {
              ...
              var t = e.querySelectorAll('*[id]');
              Array.from(t).forEach(function (e) {
                if ((e.classList.remove('show'), e.childNodes.length > 2)) {
                  var t = e.querySelectorAll('ul li a');
                  Array.from(t).forEach(function (e) {
          ...
          e.addEventListener('hide.bs.collapse', function (t) {
            t.stopPropagation();
            var a = e.querySelectorAll('.collapse');
  ...
  function i() {
    var t = document.documentElement.getAttribute('data-layout'),
      a = sessionStorage.getItem('defaultAttribute'),
      n = JSON.parse(a);
    if (n && ('twocolumn' == t || 'twocolumn' == n['data-layout'])) {
      ...
      if ((s = s.substring(s.lastIndexOf('/') + 1))) {
        var d = document
          .getElementById('navbar-nav')
          .querySelector('[href="' + s + '"]');
        if (d) {
          var i = d.closest('.collapse.menu-dropdown');
          i &&
            (i.classList.add('show'),
            i.parentElement.children[0].classList.add('active'),
            i.parentElement.children[0].setAttribute('aria-expanded', 'true'),
            i.parentElement.closest('.collapse.menu-dropdown') &&
              (i.parentElement.closest('.collapse').classList.add('show'),
              i.parentElement.closest('.collapse').previousElementSibling &&
                i.parentElement
                  .closest('.collapse')
                  .previousElementSibling.classList.add('active'),
              i.parentElement.parentElement.parentElement.parentElement.closest(
                '.collapse.menu-dropdown',
              ) &&
                (i.parentElement.parentElement.parentElement.parentElement
                  .closest('.collapse')
                  .classList.add('show'),
                i.parentElement.parentElement.parentElement.parentElement.closest(
                  '.collapse',
      ...
      if (
            ...
            e.addEventListener('click', function (a) {
              if (
                ...
                (null !==
                  ...
                  a.target.matches('i')
                    ? a.target.closest('a').classList.add('active')
                    : a.target.classList.add('active'));
                var n = document.getElementsByClassName('twocolumn-item-show');
                n.length > 0 && n[0].classList.remove('twocolumn-item-show');
                var o = (
                  a.target.matches('i') ? a.target.closest('a') : a.target
                )
                  .getAttribute('href')
                  .slice(1);
        ...
        var l = new SimpleBar(document.getElementById('navbar-nav'));
        l && l.getContentElement();
        var r = new SimpleBar(
          document.getElementsByClassName('twocolumn-iconview')[0],
        );
        r && r.getContentElement();
      }
    }
  }
  function l(e) {
    ...
    e < 1025 && e > 767
      ...
      : e >= 1025
        ...
        : e <= 767 &&
          ...
          document.querySelector('.hamburger-icon') &&
            document.querySelector('.hamburger-icon').classList.add('open'));
    var t = document.querySelectorAll('#navbar-nav > li.nav-item');
    Array.from(t).forEach(function (e) {
  ...
  function b() {
    ...
    if ((e = e.substring(e.lastIndexOf('/') + 1))) {
      ...
      if (t) {
        ...
        var a = t.closest('.collapse.menu-dropdown');
        if (a && a.parentElement.closest('.collapse.menu-dropdown')) {
          if (
            ...
            var n = a.parentElement.parentElement.parentElement.parentElement
              .closest('.collapse.menu-dropdown')
              .getAttribute('id');
          ...
          t.closest('.collapse.menu-dropdown').parentElement.classList.add(
            'twocolumn-item-show',
          );
          o = a.getAttribute('id');
          document
      ...
      } else document.body.classList.add('twocolumn-panel');
    }
  }
  function y() {
    var e =
  ...
  function v(e) {
    if (e == e) {
      ...
      if ('hidden' === e['data-sidebar-visibility'])
        (z('data-sidebar-visibility', 'hidden'),
        ...
        (z('data-sidebar-visibility', 'show'),
      ...
      switch (e['data-bs-theme']) {
        case 'light':
          (z('data-bs-theme', 'light'),
            document.documentElement.setAttribute('data-bs-theme', 'light'),
            sessionStorage.setItem('data-bs-theme', 'light'));
          break;
        case 'dark':
          (z('data-bs-theme', 'dark'),
      ...
      switch (e['data-preloader']) {
        ...
        default:
          ...
          else if ('enable' == sessionStorage.getItem('data-preloader')) {
            var t;
            (z('data-preloader', 'enable'),
              sessionStorage.setItem('data-preloader', 'enable'),
              document.documentElement.setAttribute('data-preloader', 'enable'),
  ...
  function h() {
    setTimeout(function () {
      var e = document.getElementById('navbar-nav');
      if (e) {
        var t = e.querySelector('.nav-item .active'),
          a = t ? t.offsetTop : 0;
        if (a > 300) {
          var n = document.getElementsByClassName('app-menu')
            ? document.getElementsByClassName('app-menu')[0]
            : '';
          n &&
            n.querySelector('.simplebar-content-wrapper') &&
            setTimeout(function () {
              n.querySelector('.simplebar-content-wrapper').scrollTop =
                330 == a ? a + 85 : a;
            }, 0);
        }
      }
          ...
          a.addEventListener('change', function () {
            ...
            if (
              ...
              'data-preloader' == e &&
                ...
                document.getElementById('customizerclose-btn').click());
            'data-bs-theme' == e && window.dispatchEvent(k);
          }));
      },
    ),
  ...
  function x() {
    if ('horizontal' !== document.documentElement.getAttribute('data-layout')) {
      if (document.getElementById('navbar-nav')) {
        var e = new SimpleBar(document.getElementById('navbar-nav'));
  ...
  (!(function () {
    if (sessionStorage.getItem('defaultAttribute'))
      (((t = {})['data-layout'] = sessionStorage.getItem('data-layout')),
        (t['data-sidebar-size'] = sessionStorage.getItem('data-sidebar-size')),
        (t['data-bs-theme'] = sessionStorage.getItem('data-bs-theme')),
        (t['data-layout-width'] = sessionStorage.getItem('data-layout-width')),
        (t['data-sidebar'] = sessionStorage.getItem('data-sidebar')),
        (t['data-sidebar-image'] =
          sessionStorage.getItem('data-sidebar-image')),
        (t['data-layout-position'] = sessionStorage.getItem(
          'data-layout-position',
        )),
        (t['data-layout-style'] = sessionStorage.getItem('data-layout-style')),
        (t['data-topbar'] = sessionStorage.getItem('data-topbar')),
        (t['data-preloader'] = sessionStorage.getItem('data-preloader')),
        (t['data-body-image'] = sessionStorage.getItem('data-body-image')),
        v(t));
    else {
      var e = document.documentElement.attributes,
        t = {};
      (Array.from(e).forEach(function (e) {
        if (e && e.nodeName && 'undefined' != e.nodeName) {
          var a = e.nodeName;
          ((t[a] = e.nodeValue), sessionStorage.setItem(a, e.nodeValue));
        }
      }),
        sessionStorage.setItem('defaultAttribute', JSON.stringify(t)),
        v(t));
    ...
    i(),
    (I = document.getElementById('search-close-options')),
    (S = document.getElementById('search-dropdown')),
    (w = document.getElementById('search-options')) &&
      (w.addEventListener('focus', function () {
        w.value.length > 0
          ? (S.classList.add('show'), I.classList.remove('d-none'))
          : (S.classList.remove('show'), I.classList.add('d-none'));
      }),
      w.addEventListener('keyup', function (e) {
        if (w.value.length > 0) {
          (S.classList.add('show'), I.classList.remove('d-none'));
          var t = w.value.toLowerCase(),
            a = document.getElementsByClassName('notify-item');
          Array.from(a).forEach(function (e) {
            var a = '';
            if (e.querySelector('h6')) {
              var n = e.getElementsByTagName('span')[0].innerText.toLowerCase(),
                o = e.querySelector('h6').innerText.toLowerCase();
              a = o.includes(t) ? o : n;
            } else
              e.getElementsByTagName('span') &&
                (a = e.getElementsByTagName('span')[0].innerText.toLowerCase());
            a && (e.style.display = a.includes(t) ? 'block' : 'none');
          });
        } else (S.classList.remove('show'), I.classList.add('d-none'));
      }),
      I.addEventListener('click', function () {
        ((w.value = ''), S.classList.remove('show'), I.classList.add('d-none'));
      }),
    ...
    (function () {
      var e = document.getElementById('search-close-options'),
        t = document.getElementById('search-dropdown-reponsive'),
      ...
      e &&
        ...
        (a.addEventListener('focus', function () {
          a.value.length > 0
            ? (t.classList.add('show'), e.classList.remove('d-none'))
            : (t.classList.remove('show'), e.classList.add('d-none'));
        }),
    ...
    (L = document.querySelectorAll('.light-dark-mode')) &&
      L.length &&
      L[0].addEventListener('click', function (e) {
        (A.hasAttribute('data-bs-theme') &&
        'dark' == A.getAttribute('data-bs-theme')
          ? q('data-bs-theme', 'light', 'layout-mode-light', A)
          : q('data-bs-theme', 'dark', 'layout-mode-dark', A),
      ...
      e &&
        Array.from(e).forEach(function (e) {
          !(function a() {
            ...
            (s < 1 && (s = 1),
              o < n
                ? ((e.innerText = (o + s).toFixed(0)), setTimeout(a, 1))
                : (e.innerText = t(n)),
              t(e.innerText));
          })();
        });
    ...
    (function () {
      if (document.getElementsByClassName('dropdown-item-cart')) {
        var e = document.querySelectorAll('.dropdown-item-cart').length;
        function t() {
          var e = 0;
          (Array.from(
      ...
      if (document.getElementsByClassName('notification-check')) {
        function a() {
          Array.from(
            ...
            e.querySelectorAll('.notification-item').length > 0
          ...
          Array.from(
            ...
            (e.addEventListener('change', function (e) {
              ...
              document
                ...
                .addEventListener('hide.bs.dropdown', function (t) {
                  ((e.checked = !1),
                    document
    ...
    (function () {
      var e = document.querySelectorAll('[data-toast]');
      Array.from(e).forEach(function (e) {
        e.addEventListener('click', function () {
          var t = {},
            a = e.attributes;
          (a['data-toast-text'] &&
            ...
            a['data-toast-position'] &&
              (t.position = a['data-toast-position'].value.toString()),
            a['data-toast-className'] &&
              (t.className = a['data-toast-className'].value.toString()),
            a['data-toast-duration'] &&
              (t.duration = a['data-toast-duration'].value.toString()),
            a['data-toast-close'] &&
      ...
      var a = document.querySelectorAll('[data-provider]');
      (Array.from(a).forEach(function (e) {
        if ('flatpickr' == e.getAttribute('data-provider')) {
          var t,
            a = {},
            n = e.attributes;
          ((a.disableMobile = 'true'),
            n['data-date-format'] &&
              (a.dateFormat = n['data-date-format'].value.toString()),
            n['data-enable-time'] &&
              ((a.enableTime = !0),
              (a.dateFormat = n['data-date-format'].value.toString() + ' H:i')),
            n['data-altFormat'] &&
              ((a.altInput = !0),
              (a.altFormat = n['data-altFormat'].value.toString())),
            n['data-minDate'] &&
              ((a.minDate = n['data-minDate'].value.toString()),
              (a.dateFormat = n['data-date-format'].value.toString())),
            n['data-maxDate'] &&
              ((a.maxDate = n['data-maxDate'].value.toString()),
              (a.dateFormat = n['data-date-format'].value.toString())),
            n['data-deafult-date'] &&
              ((a.defaultDate = n['data-deafult-date'].value.toString()),
              (a.dateFormat = n['data-date-format'].value.toString())),
            ...
            n['data-inline-date'] &&
              ...
              (a.dateFormat = n['data-date-format'].value.toString())),
            n['data-disable-date'] &&
              ((t = []).push(n['data-disable-date'].value),
              (a.disable = t.toString().split(','))),
            n['data-week-number'] &&
              ((t = []).push(n['data-week-number'].value),
              (a.weekNumbers = !0)),
            flatpickr(e, a));
        } else if ('timepickr' == e.getAttribute('data-provider')) {
          var o = {},
            s = e.attributes;
          (s['data-time-basic'] &&
            ((o.enableTime = !0), (o.noCalendar = !0), (o.dateFormat = 'H:i')),
            s['data-time-hrs'] &&
              ((o.enableTime = !0),
              (o.noCalendar = !0),
              (o.dateFormat = 'H:i'),
            ...
            s['data-min-time'] &&
              ...
              (o.noCalendar = !0),
              (o.dateFormat = 'H:i'),
              (o.minTime = s['data-min-time'].value.toString())),
            s['data-max-time'] &&
              ((o.enableTime = !0),
              (o.noCalendar = !0),
              (o.dateFormat = 'H:i'),
              (o.minTime = s['data-max-time'].value.toString())),
            s['data-default-time'] &&
              ((o.enableTime = !0),
              (o.noCalendar = !0),
              (o.dateFormat = 'H:i'),
              (o.defaultDate = s['data-default-time'].value.toString())),
            s['data-time-inline'] &&
              ((o.enableTime = !0),
              (o.noCalendar = !0),
              (o.defaultDate = s['data-time-inline'].value.toString()),
              (o.inline = !0)),
            flatpickr(e, o));
        }
      }),
    ...
    window.addEventListener('resize', function () {
      (B && clearTimeout(B), (B = setTimeout(x, 2e3)));
    }));
})();
